...
export const StorageManager = () => {
  ...
  const handleRefetchBalances = async () => {
    console.log("StorageManager: Refetching balances...");
    console.log("StorageManager: Current balances data before refetch:", data); // Add this log
    await refetchBalances();
    console.log("StorageManager: Balances refetched. New data:", data); // And this log
  };
  
  if (error) {
    console.error("StorageManager: Error fetching balances:", error); // Log the error here
  }
      ...
      <div className="space-y-4">
        <div
          className={`p-4 bg-red-50 rounded-lg border border-red-200 ${
            balances.filBalance === BigInt(0) ? "block" : "hidden"
          }`}
        >
        ...
        <div
          className={`p-4 bg-red-50 rounded-lg border border-red-200 ${
            balances.usdfcBalance === BigInt(0) ? "block" : "hidden"
          }`}
        >
          <p className="text-red-800">
